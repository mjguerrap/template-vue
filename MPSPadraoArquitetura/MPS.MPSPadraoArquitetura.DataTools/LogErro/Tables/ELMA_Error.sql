CREATE TABLE [LogsErro].[ELMAH_Error] (
...
CREATE NONCLUSTERED INDEX [IX_ELMAH_Error_App_Time_Seq]
    ON [LogsErro].[ELMAH_Error]([Application] ASC, [TimeUtc] DESC, [Sequence] DESC);


GO
CREATE CLUSTERED INDEX [IX_ELMAH_Error_Sequence] ON [LogsErro].[ELMAH_Error] ([Sequence])
